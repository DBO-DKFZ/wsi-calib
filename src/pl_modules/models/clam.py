# Code from https://github.com/mahmoodlab/CLAM/blob/master/models/model_clam.py
...
class CLAM_SB(nn.Module):
    """
    CLAM Model with single attention branch
    ...
    def __init__(
        ...
        if feat_size == 1024:
            ...
            raise RuntimeError("feat_size must be in [1024, 512]")
...
class CLAM_MB(CLAM_SB):
    """
    CLAM model with multiple attention branches
    """
